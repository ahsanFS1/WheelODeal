...
const MLPSchema = new mongoose.Schema(
    {
      ...
      hero: {
        headline: {
          type: String,
          required: true,
          default: "Turn Engagement Into Results With a Spinning Wheel of Fortune!",
        },
        subheadline: {
          type: String,
          required: true,
          default: "Attract, engage, and convert customers with the ultimate customizable landing page tool. Perfect for businesses of any size.",
        },
        ctaButton: {
        ...
        //     type: String,
        //     required: true,
        //     default:"https://s3.amazonaws.com/www-inside-design/uploads/2019/05/woolmarkimagelogo-1024x576.png",
        // }
      },
      demo: {
        title: { type: String, required: true, default: "See the Wheel in Action!" },
        caption: {
          type: String,
          required: true,
      ...
      benefits: {
        title: {
          type: String,
          required: true,
          default: "The Benefits of Adding Gamification to Your Marketing Strategy!",
        },
        description: {
          type: String,
          required: true,
          ...
          default: [
            {
              ...
              answer: "Each plan includes access to all core features and support.",
            },
            {
              id: "2",
